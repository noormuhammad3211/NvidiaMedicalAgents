...
if "NVIDIA_API_KEY" not in os.environ:
    os.environ["NVIDIA_API_KEY"] = "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"

# Initialize LLM
@st.cache_resource
def get_llm():
    return NVIDIA(model="nvidia/llama-3.1-nemotron-ultra-253b-v1")
